...
const products = [
  ...
  desc: "The definitive guide to integrating AI into modern web development — from architecture decisions to governance frameworks used by modern product and engineering teams.",
  link: "https://a.co/d/03x5jZKv",
  ...
  desc: "A strategic methodology for managing programs with complexity — widely used across science, technology, and innovation initiatives in Brazil.",
  link: "https://a.co/d/0fajfcR7",
    linkLabel: "Get the Book →",
    featured: false,
  },
  {
  ...
  title: "AI4XP Certification",
  meta: "AI4XP Platform · Online · Self-paced",
  ...
  },
  {
    type: "Program",
    badge: "Coming Soon",
  title: "G³ AI Full Program",
  meta: "G³AI.global · Cohort-based",
  desc: "The complete G³ AI Framework program for executives, architects, and governance professionals ready to lead AI transformation at organizational scale.",
  link: "https://g3ai.global",
